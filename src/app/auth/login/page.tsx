    ...
    <div className="min-h-screen flex items-center justify-center p-4">
      <GlassCard className="w-full max-w-md p-8">
        ...
        <div className="relative mb-6">
          ...
          <div className="relative flex justify-center text-xs"><span className="bg-surface px-2 text-text-tertiary">or with email</span></div>
        </div>

        <form className="space-y-4">
          <input type="email" placeholder="Email" className="w-full glass rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-neon-cyan/30" />
          <input type="password" placeholder="Password" className="w-full glass rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-neon-cyan/30" />
